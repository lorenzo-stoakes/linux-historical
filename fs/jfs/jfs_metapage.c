...
static metapage_t *reserved_metapages[METAPOOL_MIN_PAGES];
...
static metapage_t *alloc_metapage(int *dropped_lock, int no_wait)
{
	metapage_t *new;
...
static void __free_metapage(metapage_t *mp)
{
	mp->flag = 0;
	set_bit(META_free, &mp->flag);
